...
import com.example.mybatis_demo.domain.SwaggerProperties;
	...
	*/
	...
	public BeanPostProcessor generateBeanPostProcessor() {
		return new BeanPostProcessor() {
			...
			/**
			 * failed for mapping.getPatternParser invocation failure.
			@Override
			...
			private <T extends RequestMappingInfoHandlerMapping> void customizeSpringfoxHandlerMappings(
					List<T> mappings) {
				Stream stream =   mappings.stream();

				List<T> copy = stream.filter(mapping -> mapping.getPatternParser() == null)
